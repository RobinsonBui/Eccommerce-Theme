                ...
                <div class="pattern-product__options">
                    ...
                    <ul class="pattern-product__ul">
                        <?php foreach ($product['opciones_de_compra'] as $options) : ?>
                            <li class="pattern-product__li" data-id="<?php echo $data_product->ID; ?>" data-base-url="<?php echo esc_url(wc_get_checkout_url()); ?>">
                                <a href="#" class="pattern-product__purchase-option" data-quantity="<?php echo $options['cantidad'] ?>">
